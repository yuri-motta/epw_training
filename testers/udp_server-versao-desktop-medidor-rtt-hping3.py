...
"""COLUNAS NO ARQUIVO RESULTANTE"""

""" ip rtt timestamp ano dia mes hora minuto segundo"""
    ...
    def run(self):
        ...
        try:
            while 1:
                ...
                f.write(rtt + " " + str(ts) + " " + str(ano) + " " + str(mes) + " " + str(dia) + " " + str(hora)+ " "  + str(minutos)+ " "  + str(segundos) + "\n")
