...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        #Update the local ip
        Label(self, text="Please insert your local IP:").grid(row=13, column=1, sticky=W)
        ...
        """JOYSTICK BUTTON"""
        Label(self, text="USB JOYSTICK").grid(row=20, column=20, sticky=W)
        self.button_start_joystick = Button(self, text="START JOYSTICK", command=self.start_joystick)
        self.button_start_joystick.grid(row=21, column=20)
...
class client_joystick(Thread):
    ...
    def run(self):
        global ip_server, command_port
        subprocess.Popen(["python","../arduino_joystick/joystick_training_client.py",ip_server,str(command_port)])
